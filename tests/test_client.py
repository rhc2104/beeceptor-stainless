...
from ronnie_beeceptor_api._constants import RAW_RESPONSE_HEADER
...
class TestRonnieBeeceptorAPI:
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.get("/users", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}})
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await self.client.get(
                "/users", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
